...
### Use Lowercase Tags
HTML tags are not case sensitive: <P> means the same as <p>, **but** we recommends lowercase in HTML. Moreover, later React JavaScript library syntax will make us to use lowercase for standard in-browser tags.
